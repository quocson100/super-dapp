...
import * as SuperQNFT from '../../../build/contracts/SuperNFT.json';
import { SuperNFT } from '../../types/SuperNFT';

const DEFAULT_SEND_OPTIONS = {
    gas: 6000000
};

export class SuperNFTWrapper {
    web3: Web3;
    ...
    constructor(web3: Web3) {
        this.web3 = web3;
        this.contract = new web3.eth.Contract(SuperQNFT.abi as any) as any;
    }
